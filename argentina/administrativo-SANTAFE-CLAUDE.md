...
### Recursos administrativos Santa Fe

Aplicar Dec 4174/15. Verificar siempre:
- Plazo desde la notificación en días hábiles administrativos: revocatoria 10 días / apelación ante PE 10 días
- Cadena: revocatoria → apelación ante PE (no confundir con la cadena federal)
- Si la autoridad es el PE directamente: revocatoria ante el PE agota la vía (previa vista a Fiscalía de Estado)
- Articular en sede administrativa todas las pretensiones que se quieran plantear después en el recurso judicial
...
### Agotamiento de la vía y límite de las pretensiones judiciales

1. Verificar si se interpusieron revocatoria + apelación ante el PE en plazo
2. Verificar que el objeto del recurso judicial no supere lo planteado en sede administrativa (límite del art. 7 Ley 11.330)
3. Verificar intervención preceptiva de la Fiscalía de Estado
4. Verificar si la vía quedó agotada por silencio (art. 9 Ley 11.330)

### Responsabilidad del Estado Santa Fe

- No aplicar Ley 26.944 ni CCCN sin verificar criterio de la CSJ Santa Fe
- Verificar necesidad de reclamo administrativo previo del Dec 4174/15 antes de plantear la pretensión resarcitoria
- Consultar dictámenes de la Fiscalía de Estado sobre responsabilidad
- Verificar prescripción según criterio local

### Empleo público Santa Fe

Verificar siempre:
- Encuadre en Ley 8525 o estatuto sectorial (Ley 10.296 docentes / Ley 7395 policía / otro)
- Situación de revista del agente
- Procedimiento disciplinario de la Ley 8525: vista por 10 días, prueba en 15 días, resolución
- Si el acto de la sanción se impugna por la cadena recursiva del Dec 4174/15 antes de ir al recurso judicial

### Contratación pública Santa Fe

Verificar siempre:
- Encuadre del procedimiento según Ley 12.510 y montos vigentes
- Plazos de impugnación de pliegos y preadjudicación
- Para obra pública: verificar ley provincial aplicable, no Ley 13.064 nacional
